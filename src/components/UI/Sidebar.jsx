  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-nav">
        ...
        {/* 在线找书 */}
        <button
          className={`nav-item ${currentView === 'novelSearch' ? 'active novel-search-nav' : 'novel-search-nav'}`}
          id="sidebar-novel-search-btn"
          onClick={() => {
            useStore.getState().closeBook()
            setCurrentView('novelSearch')
          }}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
          ...
          在线找书
          <span className="novel-nav-badge">NEW</span>
        </button>

        {/* 下载管理 */}
        <button
          className={`nav-item ${currentView === 'downloadManager' ? 'active' : ''}`}
          id="sidebar-download-manager-btn"
          onClick={() => {
            useStore.getState().closeBook()
            setCurrentView('downloadManager')
          }}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        {/* 书源管理 */}
        <button
          className={`nav-item ${currentView === 'sourceEditor' ? 'active' : ''}`}
          id="sidebar-source-editor-btn"
          onClick={() => {
            useStore.getState().closeBook()
            setCurrentView('sourceEditor')
          }}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
