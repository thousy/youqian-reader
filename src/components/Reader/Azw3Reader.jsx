...
export function Azw3Reader({ book, savedProgress, settings, onProgressChange, registerGetPosition, registerSearchProvider, registerJumpTo, registerGetTtsBlocks, showToc, annotations = [], onAnnotationClick }) {
  ...
  // 注册 AZW3 听书段落与当前页精准定位获取器
  useEffect(() => {
    if (!registerGetTtsBlocks) return
    registerGetTtsBlocks(() => {
      const container = containerRef.current || document.getElementById('mobi-scroll-content')
